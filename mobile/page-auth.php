...
<!--     	<div class="container">
    ...
    <div class="container">
    	<div class="row">
            ...
            ?>
            	<p class="text-policy">
                    <?php printf(__('By creating an account, you agree to our <a href="%s" rel="noopener noreferrer" target="_Blank">Term of Use and Privacy policy</a>', ET_DOMAIN), et_get_page_link('tos') ); ?>
                </p>
            <?php
                }
            ?>
